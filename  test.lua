...
for i = 1,heater_count do
	...
	local heater_type = {heater_name,heater_cooling}
    heaters_by_type[heater_type] = (heaters_by_type[heater_type] or 0) + 1
end
local print = print
print(("Out of %d heaters :"):format(heater_count))
for name,count,cooling in pairs(heaters_by_type) do
    print(("You have %d %s heaters each cooling %s"):format(count,name,heater_cooling))
end
--[[
